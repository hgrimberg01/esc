...
admin.site.register_view('getNameTags', 'Get Nametags (May take some time)', view=GetParticipantLabels)
...
admin.site.register_view('csv/GetSchoolParticipantCsv','Get All Participants (Excel File)', view=get_school_participant_list)
